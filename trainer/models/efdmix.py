...
class EFDMix(Trainer):
    def build_model(self):
        self.model = timm.create_model(
            self.cfg.MODEL.EFDMix.BACKBONE,
            pretrained=True,
        ...
        model_parameters_table = [
            ["Model", "# Parameters"],
            ["EFDMix", f"{count_num_parameters(self.model):,}"],
        ]
        ...
        self.model_registeration("efdmix", self.model, self.optimizer, self.scheduler)
